...
class LockinField():
    ...
    def set_ac_field(self, value=0, freq): # TO DO
        self.field.set_voltage(value)
        self.field.set_channel(1)
        self.field.enable_channel()
        self.field.enable_channel_master()
