...
class IVTransfer(Procedure):
    ...
    agilent34401a_adress = Parameter("Agilent34401a adress", default=finded_instruments, group_by='agilent', group_condition=lambda v: v ==True)
    ...
    field_sensor_adress = Parameter("Field_sensor",  default=finded_instruments,group_by='mode', group_condition=lambda v: v =='Standard' )
    ...
    agilent_adress = Parameter("Agilent E3648A adress", default=finded_instruments,group_by={'field_device':lambda v: v =='Agilent E3648A'} )
