...
class IVTransfer(Procedure):
    ...
    keithley_compliance_current = FloatParameter('Compliance current', units='A', default=0.1)
    keithley_compliance_voltage = FloatParameter('Compliance voltage', units='V', default=1)
    keithley_current_bias = FloatParameter('Current bias', units='A', default=0.01)
    keithley_voltage_bias = FloatParameter('Volage bias', units='V', default=0.1)
    field_bias = FloatParameter('Field bias', units='Oe', default=1)
    voltage_vector = VectorParameter('Voltage', units='V')
    current_vector = VectorParameter('Current', units='A')
    field_vector = VectorParameter('Field', units='Oe')
